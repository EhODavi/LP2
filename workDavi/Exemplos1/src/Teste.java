...
public class Teste {
	public static void main(String[] args) {
		...
		/*
		 * end1.tipo = "casa"; end1.logradouro = "Rua das Flores"; end1.numero =
		 * 10; end1.cidade = "Timóteo"; end1.uf = "MG";
		 */
		Cliente cli1 = Cliente.newInstance("Joao", "123.456.789-10", end1);
		...
		Cliente cli2 = Cliente.newInstance("Maria", "223.232.453-11", end1);
